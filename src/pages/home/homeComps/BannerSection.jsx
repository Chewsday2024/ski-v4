    ...
    <section className="banner position-relative overflow-hidden">
      ...
      <div className='container text-white d-flex flex-column justify-content-center vh-100'>
        <div className="mb-3 z-3" data-aos="fade-right">
          <h1 className="text-lg fw-bold bg-brand-01 d-inline-block px-2 py-1 border-2 border-bottom border-white typing-effect">想滑雪？</h1>
        </div>
        <div className="mb-5 z-3" data-aos="fade-right">
          <h2 className="h1 bg-brand-01 fw-bold d-inline-block px-2 py-1 border-2 border-bottom border-white">找到你最貼心的雪地夥伴</h2>
        </div>
        <div className="z-3" data-aos="fade-right">
          <Link to="/coach" className="btn btn-outline-brand-01 home-btn-hover bg-white rounded-pill fw-bold fs-4 fw-bold px-middle py-3 z-3">
